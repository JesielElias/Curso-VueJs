    ...
    <v-toolbar app>
        ...
        <v-toolbar-items>
            ...
            <v-layout align-center>
                <span class="text-uppercase greyy--text text--darken2">
...
export default {
    ...
    methods: {
        ...
        saveData() {
            const { funds, stockPorfolio, stocks } = this.$store.getters
            this.$http.put('data.json', { funds, stockPorfolio, stocks })
        },
        loadDataLocal() {
            this.loadData()
        }
